      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-12">
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5">
            <p className="text-xs font-bold text-emerald-600 mb-1 uppercase tracking-wider">보유 기간</p>
            <p className="text-lg font-extrabold text-emerald-900">회원 탈퇴 시 즉시 파기</p>
            <p className="text-sm text-emerald-700 mt-1">법령에 따른 보존 기간 예외</p>
          </div>
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5">
            <p className="text-xs font-bold text-amber-600 mb-1 uppercase tracking-wider">이용자 권리</p>
            <p className="text-lg font-extrabold text-amber-900">열람·수정·삭제 보장</p>
            <p className="text-sm text-amber-700 mt-1">언제든 개인정보 관리 가능</p>
          </div>
        </div>
        ...
        <div className="prose prose-gray max-w-none text-[15px] leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">1. 개인정보의 처리 목적</h2>
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-gray-200 px-4 py-3 text-left font-bold text-gray-700">처리 목적</th>
                  <th className="border border-gray-200 px-4 py-3 text-left font-bold text-gray-700">상세 내용</th>
                </tr>
              </thead>
              <tbody>
                <tr>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">2. 수집하는 개인정보 항목 및 수집 방법</h2>

          <h3 className="text-base font-bold text-gray-800 mt-6 mb-3">2.1 필수 수집 항목</h3>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-gray-200 px-4 py-3 text-left font-bold text-gray-700">구분</th>
                  <th className="border border-gray-200 px-4 py-3 text-left font-bold text-gray-700">수집 항목</th>
                </tr>
              </thead>
              <tbody>
                <tr>
          ...
          <h3 className="text-base font-bold text-gray-800 mt-6 mb-3">2.2 선택 수집 항목</h3>
          ...
          <h3 className="text-base font-bold text-gray-800 mt-6 mb-3">2.3 자동 수집 항목</h3>
          <ul className="list-disc pl-6 space-y-1">
            <li>IP 주소, 쿠키, 서비스 이용 기록, 방문 일시, 기기 정보(OS, 브라우저 종류)</li>
          </ul>

          <h3 className="text-base font-bold text-gray-800 mt-6 mb-3">2.4 수집 방법</h3>
          <ul className="list-disc pl-6 space-y-1">
            <li>회원가입 및 서비스 이용 과정에서 이용자가 직접 입력</li>
            <li>서비스 이용 과정에서 자동으로 생성·수집</li>
          </ul>

          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">3. 개인정보의 처리 및 보유 기간</h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-gray-200 px-4 py-3 text-left font-bold text-gray-700">보유 항목</th>
                  <th className="border border-gray-200 px-4 py-3 text-left font-bold text-gray-700">보유 기간</th>
                  <th className="border border-gray-200 px-4 py-3 text-left font-bold text-gray-700">근거 법령</th>
                </tr>
              </thead>
              <tbody>
                <tr>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">4. 개인정보의 제3자 제공</h2>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">5. 개인정보 처리의 위탁</h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-gray-200 px-4 py-3 text-left font-bold text-gray-700">수탁업체</th>
                  <th className="border border-gray-200 px-4 py-3 text-left font-bold text-gray-700">위탁 업무 내용</th>
                </tr>
              </thead>
              <tbody>
                <tr>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">6. 정보주체의 권리·의무 및 행사 방법</h2>
          ...
          <p className="text-gray-600 mt-3">권리 행사는 이메일(support@onsia.city)을 통하여 하실 수 있으며, 회사는 이에 대해 지체 없이 조치하겠습니다.</p>

          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">7. 개인정보의 파기 절차 및 방법</h2>

          <h3 className="text-base font-bold text-gray-800 mt-6 mb-3">7.1 파기 절차</h3>
          ...
          <h3 className="text-base font-bold text-gray-800 mt-6 mb-3">7.2 파기 방법</h3>
          <ul className="list-disc pl-6 space-y-1">
            <li><strong>전자적 파일 형태</strong>: 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제</li>
            <li><strong>종이에 출력된 개인정보</strong>: 분쇄기로 분쇄하거나 소각하여 파기</li>
          </ul>

          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">8. 개인정보의 안전성 확보 조치</h2>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">9. 쿠키(Cookie)의 설치·운영 및 거부</h2>

          <h3 className="text-base font-bold text-gray-800 mt-6 mb-3">9.1 쿠키의 사용 목적</h3>
          ...
          <h3 className="text-base font-bold text-gray-800 mt-6 mb-3">9.2 쿠키의 거부 방법</h3>
          <p className="text-gray-600 mb-3">이용자는 웹브라우저 설정을 통해 쿠키 저장을 거부할 수 있습니다. 다만, 쿠키 저장을 거부할 경우 로그인이 필요한 일부 서비스의 이용이 어려울 수 있습니다.</p>

          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">10. 개인정보 보호책임자</h2>

          <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 my-4">
            <div className="space-y-2 text-sm">
              <p className="font-bold text-gray-800 mb-3">개인정보 보호책임자</p>
              <p><strong>성명</strong>: 연대겸</p>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">11. 권익침해 구제방법</h2>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 my-4">
            <div className="space-y-3 text-sm">
              <div>
                <p className="font-bold text-gray-800">개인정보분쟁조정위원회</p>
                <p className="text-gray-600">전화: 1833-6972 | 홈페이지: www.kopico.go.kr</p>
              </div>
              <div>
                <p className="font-bold text-gray-800">개인정보침해신고센터 (한국인터넷진흥원)</p>
                <p className="text-gray-600">전화: 118 | 홈페이지: privacy.kisa.or.kr</p>
              </div>
              <div>
                <p className="font-bold text-gray-800">대검찰청 사이버수사과</p>
                <p className="text-gray-600">전화: 1301 | 홈페이지: www.spo.go.kr</p>
              </div>
              <div>
                <p className="font-bold text-gray-800">경찰청 사이버수사국</p>
                <p className="text-gray-600">전화: 182 | 홈페이지: ecrm.cyber.go.kr</p>
              </div>
            </div>
          </div>

          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">12. 개인정보 처리방침 변경</h2>
