...
// 하위호환 — 기존 import 경로(`@/components/market/MarketMap.client`) 유지용 타입 재export
export type { MapComplexPoint, DealTypeFilter, MapAggregatePoint } from '@/lib/market/marker-html';

const NAVER_CLIENT_ID = process.env.NEXT_PUBLIC_NAVER_MAP_CLIENT_ID || '';

export type MarkerMode = 'complex' | 'dong' | 'gu';

// MapAggregatePoint 는 @/lib/market/marker-html 로 이동 (/stay 실거래 레이어와 공유) — 위에서 재export.
...
// 마커 팔레트 / buildMarkerHTML 은 @/lib/market/marker-html 로 이동 (/stay 와 공유).

// buildAggMarkerHTML 은 @/lib/market/marker-html 로 이동 (/stay 실거래 레이어와 공유).
