...
export default function BannerBuilderModal({
  ...
  const handleApply = useCallback(() => {
    const bannerHtml = bgUrl
      ...
      : '';
    // Use HTML generated by StructuredJobForm
    const templateHtml = structuredHtml || undefined;
    // Sync title/subtitle back to form fields
    onTitleChange?.(title, subtitle);
    onApply(bannerHtml, templateHtml);
    onClose();
  }, [bgUrl, logoUrl, title, subtitle, presetId, opacity, structuredHtml, onApply, onClose, onTitleChange]);
          ...
          <div className="flex-1 overflow-y-auto bg-gray-50 p-5">
              ...
              <div className="mt-3 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="px-4 py-2 border-b border-gray-100 bg-blue-50">
                  <p className="text-[11px] font-bold text-blue-600">
                    ③ 상세 내용 입력 — {selectedTemplate.name}
                  </p>
                </div>
                <div className="px-4 py-3 max-h-[450px] overflow-y-auto">
                  <StructuredJobForm
                    ...
                    onHtmlChange={setStructuredHtml}
                  />
                </div>
              </div>
            )}
            ...
            <div className="mt-4 p-3 bg-blue-50 rounded-lg">
              <p className="text-xs text-blue-700">
                {selectedTemplate
                  ? <>위 항목을 클릭/입력한 후 <strong>적용하기</strong>를 누르면 배너 + 양식이 함께 에디터에 삽입됩니다.</>
